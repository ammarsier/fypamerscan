    ...
    <div class="container">
        ...
        <div class="table-container">
            <table>
                ...
                <tbody>
                    <?php foreach ($advisor_availability as $availability): ?>
                    <tr>
                        <td><?php echo htmlspecialchars($availability['advisor_id']); ?></td>
                        <td><?php echo htmlspecialchars($availability['advisor_name']); ?></td>
                        <td><?php echo htmlspecialchars($availability['available_date']); ?></td>
                        <td><?php echo htmlspecialchars($availability['available_time']); ?></td>
                    </tr>
                    <?php endforeach; ?>
                </tbody>
            </table>
