...
if ($_SERVER['REQUEST_METHOD'] == 'POST') {
    ...
    $student_name = sanitizeInput($_POST['student_name'], $conn);
    ...
    $stmt->bind_param("ssss", $student_id, $student_name, $email, $hashed_password);

    if ($stmt->execute()) {
        session_unset();
        $_SESSION['student_id'] = htmlspecialchars($student_id, ENT_QUOTES, 'UTF-8');
        $_SESSION['student_name'] = htmlspecialchars($student_name, ENT_QUOTES, 'UTF-8');
